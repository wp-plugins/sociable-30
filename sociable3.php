...
class Sociable {
    ...
    function Sociable() {
        ...
        $this->sites = apply_filters('sociable_known_sites',  $this->sites);  /* Can be used by other plugins to add additional sites */
    ...
    function shortcode_hook($atts) {
        ...
        if ((is_feed() and isset($conditionals['is_feed']))) {
            $html = $this->get_links(null, null, false);  // Suppress tooltips in RSS
    ...
    function content_hook($content='') {
        ...
        if ((is_home()     and isset($conditionals['is_home'])) or
            ...
            $html = $this->get_links(null, null, false);
            $html = strip_tags($html, "<a><img>");
            $content .= $html . "<br/><br/>";
        }
     ...
     */
    function get_links($display = null, $tagline = null, $tooltips = null) {
        global $post;
        ...
        foreach( (array)$display as $sitename ) {
            ...
            $link .= $this->show_site($sitename, $iconurl, $tooltips, $disablealpha, true, $usetargetblank);
            $link .= "</li>";
    ...
    function get_active_sites($active_sites=null, $iconset_name=null, $icon_size=null) {
        ...
        foreach ($sites as $sitename => $site) {
            ...
            $html .= $this->show_site($sitename, $iconurl, false, true, false);
            $html .= $sitename;
            $html .= "</li>";
        }
        $html .= "</ul>";
    ...
    function show_site($sitename, $iconurl, $tooltips=false, $disablealpha=true, $link=false, $usetargetblank=false) {
        if (!isset($this->sites[$sitename]))
            return "";
        else
